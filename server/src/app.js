...
const allowedOrigins = process.env.NODE_ENV === 'production'
    ? ['https://hoorberryindia.com', 'https://admin.hoorberryindia.com', 'https://hoorberryindia.com']
    : ['http://localhost:4000', 'http://localhost:8081', 'http://localhost:8082', 'http://localhost:5173', 'https://hoorberryindia.com'];
...
app.get('/', (req, res) => {
    res.json({
        ...
        documentation: process.env.NODE_ENV === 'production'
            ? 'https://api.hoorberryindia.com/docs'
